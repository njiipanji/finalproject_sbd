		...
		<main>
			<div class="container">
				<div class="center"><br><br><br>
					...
					<h2>ADD PROFILE</h2>
					<p class="center-align light">Menambah data diri petugas.<br><br></p>
				</div>
			</div>
			<div class="container">
				<div class="row">
					<div class="col s12 m12 l12">
						<div id="input" class="section scrollspy">
							<div class="row">
								<!--Form-->
								<form class="col s12" action="add_auth.php" method="post">
									<div class="col s12 m12 l8 offset-l2">
										<!--Box-->
										<div class="card-panel grey lighten-5 z-depth-1">
											<div class="row">
												<h5 class="center-align">TAMBAH DATA PETUGAS</h5>
												<div class="col s12 m11 l11" id="noID">
													<div class="input-field col s2 center">
														<i class="small material-icons">person_pin</i>
													</div>
													<div class="input-field col s10">
														<input name="id_petugas" id="id_petugas" type="text">
