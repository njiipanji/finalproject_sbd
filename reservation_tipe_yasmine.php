				...
				<div class="row">
					<div class="col s12 m12 l12">
						<div id="input" class="section scrollspy">
							<div class="row">
								<!--Form-->
								<form class="col s12" action="reservation_kamar_yasmine.php" method="post">
									<div class="col s12 m12 l8 offset-l2">
										<!--Box-->
										<div class="card-panel grey lighten-5 z-depth-1">
											<div class="row">
												<h5 class="center-align">YASMINE</h5>
												<div class="col s12">
													<div class="icon-block">
														<p class="center-align">
															<input name="tipe_kamar" id="tipe_rent" type="radio" checked>
															<label for="tipe_rent">Rent House</label>
														</p>
													</div>
												</div>
											</div>
